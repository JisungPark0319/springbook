...
public class contentLog {
	@AfterThrowing(pointcut="logPointcut.allPointcut()", throwing="exceptObj")
	 public void exceptionLog(JoinPoint jp, Exception exceptObj) {
		 ...
		 System.out.println("[Content Log] ===> " + method + "() 메소드 실행 중 예외 발생!");
		 
		 if(exceptObj instanceof Exception) {
			 System.out.println("[Content Log Exception] ===> 예외발생 : " + exceptObj);
		 }
	 }
	...
	public Object aroundLog(ProceedingJoinPoint pjp) throws Throwable {
		...
		System.out.println("[Content Log] ===> " + method + "() 메소드 수행 시간 : " + stopWatch.getTotalTimeMillis() + "(ms)초");
		return obj;
	}
}
